...
export default async function AdminDashboardPage() {
  const fallbackStats = [
    ...
    { label: "Syllabus Enrollments", value: 342 },
    { label: "Live Bookings", value: 89 },
    { label: "CRM Leads", value: 45 },
  ...
  try {
    ...
    console.warn("AdminDashboardPage rendering fallback warning:", pageErr);
    return (
      <div className="space-y-8">
        <div>
          <h1 className="font-display text-3xl text-foreground">
